import {ProyectInterface} from '../types/portfolio'



export const proyects: ProyectInterface[] = [

    {
        id: 1,
        tittle:'JC PERSONAL TRAINER',
        description:'Desarrollo de landing page Jc personal trainer con el objetivo de difundir el trabajo de un grupo de entrenadores de Córdoba Capital, creada con Next.js 14, Typescript y diseñada con Tailwind y Shadcn',
        url:'https://jcpersonaltrainer.vercel.app/',
        img:'/jcptrainer.png'      
    },
    {
        id: 2,
        tittle:'QUIEN JUEGA HOY',
        description:'Agenda deportiva de fútbol exclusivamente, con el fin de informar sobre los partidos de hoy y mañana, con horario argentino. Utilicé Next js y Material UI, consumiendo API de fútbol',
